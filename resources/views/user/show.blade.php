            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class ="md:flex md:justyfy-around">
                    ...
                    <div class="md:w-1/2 ml-4">
                        ...
                        <p class="flex leading-relaxed">{{ $product->information }}</p>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <select name="quantity" class="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10">
                                      @for($i = 1; $i <= $quantity; $i++)
                                        <option php rtivalue="{{$i}}">{{$i}}</option>
                                      @endfor
                                    </select>
                                </div>
                            </div>
                ...
                <div class="mb-4 text-center">
                    ...
                    <button data-micromodal-trigger="modal-1" fref='javascript:;' type="button" class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded">ショップの詳細を見る</button>
                </div>
            </div>
        </div>
    </div>
